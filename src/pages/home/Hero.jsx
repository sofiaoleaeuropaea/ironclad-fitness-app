			...
			<div className="container">
				<div className="hero__wrapper">
					...
					<div className="hero__image">
						<ScrollReveal>
							<img src="assets/images/hero_mobile.png" className="img-fluid" id="hero-img_mobile" alt="Strong men" />
							<img src="assets/images/hero_desktop.png" className="img-fluid" id="hero-img_desktop" alt="Strong men" />
						</ScrollReveal>
					</div>
				</div>
			</div>
