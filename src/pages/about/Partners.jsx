          ...
          {partners.map((partner, index) => (
            <Accordion
              ...
              content={partner.brands.map((brand, index) => {
                const imagePath = `${import.meta.env.BASE_URL}${brand.logo}`;
                return (
                  <li key={index}>
                    <NavLink to={brand.url}>
                      <img
                        src={imagePath}
                        alt={brand.name}
                        className='img-fluid partner__img'
                      />
                    </NavLink>
                  </li>
                );
